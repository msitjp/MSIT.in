...
class AttendanceAdmin(admin.ModelAdmin):
    list_display = ['title', 'shift', 'department', 'semester', 'pdf', 'created_at', 'updated_at']
    list_filter = ('shift', 'department', 'semester',)
    ordering = ('semester',)
    list_editable = ('pdf',)

class SyllabusAdmin(admin.ModelAdmin):
    list_display = ['title', 'department', 'semester', 'syllabus', 'lecture_plan', 'created_at', 'updated_at']
